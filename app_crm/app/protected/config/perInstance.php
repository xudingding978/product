<?php
    ...
    $theme            = 'default';
    $connectionString = 'mysql:host=127.0.0.1;port=3306;dbname=zurmo'; // Not Coding Standard
    $username         = 'root';
    $password         = 'Pa55word';
    ...
    $instanceConfig['components']['request']['hostInfo']         = 'http://crm.develop.trendsideas.com';
    ...
    define('ZURMO_TOKEN', '945b859e1ce7b26');
?>
