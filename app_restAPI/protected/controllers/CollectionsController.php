...
//            if ($type === 'profile') {
//                $docID = $this->getDomain() . "/profiles/" . $owner_id;
//                $tempCollection = $cb->get($docID);
//                $collection = CJSON::decode($tempCollection, true);
//                $records =  $collection["profile"][0]["collections"];
//                $collection_num = $this -> getSelectedcollection($records ,$id);
//                array_splice($collection["profile"][0]["collections"], $collection_num, 1);
//            } else {
//                $docID = $this->getDomain() . "/users/" . $owner_id;
//                $tempCollection = $cb->get($docID);
//                $collection = CJSON::decode($tempCollection, true);
//                $records =  $collection["user"][0]["collections"];
//                $collection_num = $this -> getSelectedcollection($records ,$id);
//                array_splice($collection["user"][0]["collections"], $collection_num, 1);
//            }
//                    
//                     if ($cb->set($docID, CJSON::encode($collection))) {
                $this->sendResponse(204);
//            } else {
//                $this->sendResponse(500, "some thing wrong");
//            }
