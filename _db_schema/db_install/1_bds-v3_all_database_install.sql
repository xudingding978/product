CREATE DATABASE  IF NOT EXISTS `bds-v3_live` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `bds-v3_live`;
...
CREATE DATABASE  IF NOT EXISTS `bds-v3_admin` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `bds-v3_admin`;
-- MySQL dump 10.13  Distrib 5.5.20, for linux2.6 (x86_64)
--
-- Host: 127.0.0.1    Database: bds-v3_admin
-- ------------------------------------------------------
-- Server version	5.5.20-log
...
--
-- Dumping routines for database 'bds-v3_admin'
--
