        ...
        'components' => array(
            ...
            'minScript' => array(
                ...
                'groupMap' => array(
                    ...
                    'js' => array(
                        INSTANCE_ROOT . DIRECTORY_SEPARATOR . '/../common/protected/lib/Yii/web/js/source/jquery.min.js',
                        INSTANCE_ROOT . DIRECTORY_SEPARATOR . '/../common/protected/lib/Yii/web/js/source/jquery.yii.js',
                        INSTANCE_ROOT . DIRECTORY_SEPARATOR . '/../common/protected/lib/Yii/web/js/source/jquery.ba-bbq.min.js',
                        INSTANCE_ROOT . DIRECTORY_SEPARATOR . '/../common/protected/lib/Yii/web/js/source/jui/js/jquery-ui.min.js',
                        INSTANCE_ROOT . DIRECTORY_SEPARATOR . '/../common/protected/lib/Yii/web/js/source/jquery.yiiactiveform.js',
                        INSTANCE_ROOT . DIRECTORY_SEPARATOR . '/../common/protected/lib/Yii/web/js/source/jquery.cookie.js',
                        INSTANCE_ROOT . DIRECTORY_SEPARATOR . '/../common/protected/lib/Yii/web/js/source/jquery.treeview.js',
                        INSTANCE_ROOT . DIRECTORY_SEPARATOR . '/../common/protected/lib/Yii/web/js/source/jquery.treeview.edit.js',
