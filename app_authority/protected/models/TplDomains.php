...
/**
 * This is the model class for table "tpl_domains".
 *
 * The followings are the available columns in table 'tpl_domains':
 ...
 */
class TplDomains extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return TplDomains the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
			'tplDomainDirectories' => array(self::HAS_MANY, 'TplDomainDirectory', 'DOMAIN_ID'),
		);
	}
