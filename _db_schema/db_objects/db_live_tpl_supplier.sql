...
CREATE TABLE `tpl_supplier` (
  ...
  KEY `fk_tpl_supplier_1` (`CLIENT_ID`),
  CONSTRAINT `fk_tpl_supplier_1` FOREIGN KEY (`CLIENT_ID`) REFERENCES `tpl_client` (`REC_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
