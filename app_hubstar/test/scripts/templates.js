...
function program5(depth0,data) {
  ...
  var buffer = '', hashTypes, hashContexts;
  data.buffer.push("\n                <div class='hint--left hint--rounded' data-hint='Edit Photo Info' style=\"position: absolute; right: 40px; top: 15px;\">\n                    <i class=\"icon-edit\" ");
  hashTypes = {};
  hashContexts = {};
...
function program10(depth0,data) {
  ...
  data.buffer.push("\n                            <div href=\"#question_modal\" role=\"button\" class=\"disabled-btn disabled-green\" data-toggle=\"modal\" style=\"margin:10px auto;display: block;width: 150px;\"><i class='icon-circle-blank' >&nbsp; </i> Following</div>\n                            ");
  }
...
function program33(depth0,data) {
  ...
  var buffer = '', stack1, hashContexts, hashTypes, options;
  data.buffer.push("photo_source_id\n                                    ");
  hashContexts = {'type': depth0,'class': depth0,'value': depth0};
  hashTypes = {'type': "STRING",'class': "STRING",'value': "ID"};
  options = {hash:{
    'type': ("text"),
