...
//                ->filters($filter);
        ...
        //Raw Term Query
        $json = '{"query":{"bool":{"must":[{"query_string":{"default_field":"couchbaseDocument.doc.type","query":"profile OR photo  OR article"}}],"must_not":[],"should":[]}},"from":0,"size":50,"sort":[],"facets":{}}';
