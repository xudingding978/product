...
//                ->filters($filter);
        ...
        //Raw Term Query
        $json = '{"query":{"bool":{"must":[{"query_string":{"default_field":"couchbaseDocument.doc.type","query":"photo OR profile OR article"}}],"must_not":[],"should":[]}},"from":0,"size":500,"sort":[],"facets":{}}';
