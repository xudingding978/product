...
function program2(depth0,data) {
  ...
  data.buffer.push("\n                    </div>\n                </div>\n\n                <div style=\"width: 300px;height: 45px;margin: 0 auto 20px;background-color: #fff;text-align: center;color: #888;font-weight: bold; font-size: 15px;line-height: 45px; border-radius: 0 0 5px 5px\"> Register</div>\n            </div>\n\n        </div>\n        <!--End of email register section-->\n\n        <span style=\"font-family: 'Montserrat', sans-serif; font-size: 14px;color: #fff;margin: 15px auto;opacity: .7;display: block;\">Learn more</span>\n    </div>\n\n\n</div>    \n\n<script>\n    // $('#register-with-email-drop-down').hide('1000').attr(\"display:none\");\n    $(\"#click-register-social\").click(function() {\n        $('#social-link').animate({height: 'toggle'});\n\n\n    });\n\n    $(\"#click-register\").click(function() {\n        $('#social-link').animate({height: 'toggle'});\n        $('#register-with-email-drop-down').animate({height: 'toggle'});\n    });\n\n</script>");
  return buffer;
